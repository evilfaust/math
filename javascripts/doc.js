...
/***/ function(module, exports, __webpack_require__) {
	...
	var _applicationService = __webpack_require__(139);

	var _applicationService2 = _interopRequireDefault(_applicationService);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var applicationService = new _applicationService2.default(document.getElementById('application'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = function (_React$Component) {
		...
		function Login(props) {
			...
			_this.loginChange = _this.loginChange.bind(_this);
		...
		_createClass(Login, [{
			...
			value: function loginChange(e) {
				...
				this.login = this.values.login;
				this.password = this.values.password;
				this.email = this.values.email;
			}
		}, {
			key: 'sendLogin',
			value: function sendLogin(e) {
				e.preventDefault();
				console.log(this.values);
				request.post('http://localhost:8080/add/user').withCredentials().send({ login: this.login }).send({ password: this.password }).send({ email: this.email }).end();
			}
		}, {
			key: 'render',
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('i', { className: 'icon fa fa-user fa-2x' }),
						...
						_react2.default.createElement(
							'div',
							{ className: 'login-item' },
							_react2.default.createElement('i', { className: 'icon fa fa-lock fa-2x' }),
							_react2.default.createElement('input', {
								className: 'login-input',
								id: 'password',
						...
						_react2.default.createElement(
							'div',
							{ className: 'login-item' },
							_react2.default.createElement('i', { className: 'icon fa fa-envelope-o fa-2x' }),
							_react2.default.createElement('input', {
								className: 'login-input',
								id: 'email',
						...
						_react2.default.createElement(
							'div',
							{ className: 'button', onClick: this.sendLogin },
							'Register'
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Docs = function (_React$Component) {
		...
		function Docs(props) {
			...
			_this.displayName = 'Docs';

			_this.docStyle = "doc-group-" + _this.props.style;
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_icon2.default, { icon: 'fa-file', size: 'fa-2x' })
							)
						),
						_react2.default.createElement(
							'div',
						...
						_react2.default.createElement('div', { className: 'doc-line' })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Icon = function (_React$Component) {
	    ...
	    function Icon(props) {
	        ...
	        _this.icon = "fa " + _this.props.icon + " " + _this.props.size;
	        return _this;
	    }
	    ...
	    _createClass(Icon, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('i', { className: this.icon });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _docBase = __webpack_require__(128);

	var _docBase2 = _interopRequireDefault(_docBase);

	var _docLocal = __webpack_require__(129);

	var _docLocal2 = _interopRequireDefault(_docLocal);
	...
	var DocsView = function (_React$Component) {
		_inherits(DocsView, _React$Component);

		function DocsView(props) {
			_classCallCheck(this, DocsView);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DocsView).call(this, props));

			_this.displayName = 'DocsView';
			return _this;
		}
		...
		_createClass(DocsView, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_docBase2.default, null),
					_react2.default.createElement(_docLocal2.default, null)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Teachers = function (_React$Component) {
		...
		function Teachers(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Teachers).call(this, props));

			_this.displayName = 'Teachers';
			_this.aniBlur = _this.aniBlur.bind(_this);
			_this.aniFocus = _this.aniFocus.bind(_this);
		...
		_createClass(Teachers, [{
			key: 'aniFocus',
			value: function aniFocus() {
				this.setState({
					ImegAni: "animated tada"
				});
			}
		}, {
			key: 'aniBlur',
			value: function aniBlur() {
				this.setState({
					ImegAni: ""
				});
			}
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'teacher-items col-teacher' },
					_react2.default.createElement('div', { className: 'box-head' }),
					_react2.default.createElement('img', { className: this.state.ImegAni, src: this.props.imgLink }),
					_react2.default.createElement(
						'div',
						{ className: 'title' },
						this.props.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homeView = __webpack_require__(132);

	var _homeView2 = _interopRequireDefault(_homeView);

	var _docsView = __webpack_require__(73);

	var _docsView2 = _interopRequireDefault(_docsView);

	var _teachersView = __webpack_require__(138);

	var _teachersView2 = _interopRequireDefault(_teachersView);
	...
	exports.default = _react2.default.createElement(
		...
		_react2.default.createElement(_reactRouter.Route, { path: 'doc', component: _docsView2.default }),
		_react2.default.createElement(_reactRouter.Route, { path: 'teacher', component: _teachersView2.default })
	);
		...
		_createClass(Container, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'container' },
					_react2.default.createElement(_navbar2.default, { hide: hidden }),
					_react2.default.createElement(
						'div',
						null,
						' ',
					...
					_react2.default.createElement(_footer2.default, { hide: hidden })
				);
			}
		}]);
	...
	var Footer = function (_React$Component) {
		...
		_createClass(Footer, [{
			...
			value: function render() {
				...
				if (hide) return _react2.default.createElement('span', null);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = function (_React$Component) {
		...
		_createClass(Modal, [{
			key: 'open',
			value: function open() {
				this.setState({ activ: "modal open" });
			}
		}, {
			key: 'close',
			value: function close() {
				this.setState({ activ: "modal close" });
			}
		}, {
			key: 'render',
			value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DocsBase = function (_React$Component) {
					_inherits(DocsBase, _React$Component);

					function DocsBase(props) {
									_classCallCheck(this, DocsBase);

									var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DocsBase).call(this, props));

									_this.displayName = 'DocsBase';
									return _this;
					}

					_createClass(DocsBase, [{
									key: 'render',
									value: function render() {
													return _react2.default.createElement(
																	'div',
																	...
																	_react2.default.createElement(
																					'div',
																					{ className: 'info-block-primary' },
																					_react2.default.createElement(_docs2.default, {
																									style: 'primary',
																									docLink: 'https://yadi.sk/i/jzb3TVDhg8Nimary',
																									date: '16.03.2015',
																									title: 'Устав лицея',
																									description: ''
																					}),
																					_react2.default.createElement(_docs2.default, {
																									style: 'primary',
																									docLink: 'https://yadi.sk/d/7MkPh4ZadziGa',
																									date: '19.12.2014',
																									title: 'Лицензия',
																									description: 'Лицензия на право проведения образовательной деятельности'
																					}),
																					_react2.default.createElement(_docs2.default, {
																									style: 'primary',
																									docLink: 'https://yadi.sk/i/J1T58UcTdziQr',
																									date: '19.12.2014',
																									title: 'Приложение к лицензии',
																									description: 'Приложение к лицензии на право проведения образовательной деятельности'
																					}),
																					_react2.default.createElement(_docs2.default, {
																									style: 'primary',
																									docLink: 'https://yadi.sk/i/dTTL6BHRf2dxu',
																									date: '18.02.2015',
																					...
																					_react2.default.createElement(_docs2.default, {
																									style: 'primary',
																									docLink: 'https://yadi.sk/i/Q4POAZ0qf2e4k',
																									date: '18.02.2015',
																					...
																					_react2.default.createElement(_docs2.default, {
																									style: 'primary',
																									docLink: 'https://yadi.sk/d/pV24yNSwkvRY8',
																									date: '15.11.2015',
																									title: 'План ФХД',
																									description: ''
																					}),
																					_react2.default.createElement(_docs2.default, {
																									style: 'primary',
																									docLink: 'http://yadi.sk/d/30oPvhWw13qDI',
																									date: '17.11.2012',
																					...
																					_react2.default.createElement(_docs2.default, {
																									style: 'primary',
																									docLink: 'https://yadi.sk/d/AFi2jx5gq58qs',
																									date: '11.03.2016',
																									title: 'Паспорт Дорожного движения',
																									description: ''
																					})
																	)
													);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DocsLocal = function (_React$Component) {
		_inherits(DocsLocal, _React$Component);

		function DocsLocal(props) {
			_classCallCheck(this, DocsLocal);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DocsLocal).call(this, props));

			_this.displayName = 'DocsLocal';
			return _this;
		}

		_createClass(DocsLocal, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'div',
						{ className: 'info-doc-danger' },
						_react2.default.createElement(
							'div',
							{ className: 'title' },
							'Локальные норматимные акты'
						)
					),
					_react2.default.createElement(
						'div',
						{ className: 'info-block-danger' },
						_react2.default.createElement(_docs2.default, {
							style: 'danger',
							docLink: 'https://yadi.sk/i/Npu0FE7XkvRjd',
							date: '17.10.2015',
						...
						_react2.default.createElement(_docs2.default, {
							style: 'danger',
							docLink: 'https://dl.dropboxusercontent.com/u/407981/file/06122013/%D0%9F%D0%BE%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5%20%D0%BE%20%D0%BF%D0%BE%D1%80%D1%8F%D0%B4%D0%BA%D0%B5%20%D0%BF%D0%B5%D1%80%D0%B5%D0%B2%D0%BE%D0%B4%D0%B0%2C%20%D0%BE%D1%82%D1%87%D0%B8%D1%81%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F%20%D0%B8%20%D0%B2%D0%BE%D1%81%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F.docx',
							date: '09.09.2013',
							title: 'Положение',
							description: 'порядке перевода, отчисления и восстановления'
						}),
						_react2.default.createElement(_docs2.default, {
							style: 'danger',
							docLink: 'http://yadi.sk/d/ZHRPGIywKk7fd',
							date: '18.03.2014',
						...
						_react2.default.createElement(_docs2.default, {
							style: 'danger',
							docLink: 'https://dl.dropboxusercontent.com/u/407981/lyceu9doc/%D0%9F%D0%BE%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5%20%D0%BE%20%D1%82%D0%B5%D0%BA%D1%83%D1%89%D0%B5%D0%BC%20%D0%BA%D0%BE%D0%BD%D1%82%D1%80%D0%BE%D0%BB%D0%B5%20%D1%83%D1%81%D0%BF%D0%B5%D0%B2%D0%B0%D0%B5%D0%BC%D0%BE%D1%81%D1%82%D0%B8%20%D0%B8%20%D0%BF%D1%80%D0%BE%D0%BC%D0%B5%D0%B6%D1%83%D1%82%D0%BE%D1%87%D0%BD%D0%BE%D0%B9%20%D0%B0%D1%82%D1%82%D0%B5%D1%81%D1%82%D0%B0%D1%86%D0%B8%D0%B8.pdf',
							date: '29.09.2014',
							title: 'Формы, периодичность и порядок текущего контроля успеваемости и промежуточной аттестации',
							description: ''
						}),
						_react2.default.createElement(_docs2.default, {
							style: 'danger',
							docLink: 'https://dl.dropboxusercontent.com/u/407981/file/06122013/%D0%9F%D0%BE%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5%20%D0%BE%20%D1%82%D0%B5%D0%BA%D1%83%D1%89%D0%B5%D0%BC%20%D0%BA%D0%BE%D0%BD%D1%82%D1%80%D0%BE%D0%BB%D0%B5%20%D1%83%D1%81%D0%BF%D0%B5%D0%B2%D0%B0%D0%B5%D0%BC%D0%BE%D1%81%D1%82%D0%B8%20%D0%B8%20%D0%BF%D1%80%D0%BE%D0%BC%D0%B5%D0%B6%D1%83%D1%82%D0%BE%D1%87%D0%BD%D0%BE%D0%B9%20%D0%B0%D1%82%D1%82%D0%B5%D1%81%D1%82%D0%B0%D1%86%D0%B8%D0%B8.docx',
							date: '09.09.2013',
							title: 'Положение',
							description: 'текущем контроле успеваемости и промежуточной аттестации'
						}),
						_react2.default.createElement(_docs2.default, {
							style: 'danger',
							docLink: 'https://yadi.sk/i/KXZ3S15Xj63x7',
							date: '01.09.2015',
							title: 'Приказ о календарном учебном графике',
							description: ''
						}),
						_react2.default.createElement(_docs2.default, {
							style: 'danger',
							docLink: 'http://yadi.sk/d/GnNCDaMZNehWK',
							date: '29.04.2014',
						...
						_react2.default.createElement(_docs2.default, {
							style: 'danger',
							docLink: 'https://yadi.sk/i/uHt_L6b5oWuo2',
							date: '08.02.2016',
							title: 'Приказ.',
							description: 'Об утверждении акта проверки муниципального бюджетного общеобразовательного учреждения Лицей №9 им. К.Э. Циолковского города Калуги.'
						})
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Autorize = function (_React$Component) {
		_inherits(Autorize, _React$Component);

		function Autorize(props) {
			_classCallCheck(this, Autorize);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Autorize).call(this, props));

			_this.render = _this.render.bind(_this);
			_this.handler = _this.handler.bind(_this);
			_this.autorize = _this.autorize.bind(_this);
			_this.returnLogin = _this.returnLogin.bind(_this);
			_this.openmodal = _this.openmodal.bind(_this);
			_this.blurInputLogin = _this.blurInputLogin.bind(_this);
			_this.focusInputLogin = _this.focusInputLogin.bind(_this);
			_this.blurInputPassword = _this.blurInputPassword.bind(_this);
			_this.focusInputPassword = _this.focusInputPassword.bind(_this);
		...
		_createClass(Autorize, [{
			...
			key: 'autorize',
			value: function autorize() {
				console.log('send');
				request.post('http://localhost:8080/user/authorize').withCredentials().send({ login: this.login }).send({ password: this.password }).send({ email: this.email }).end();
			}
		}, {
			key: 'blurInputLogin',
			value: function blurInputLogin() {
				this.setState({
					activ_login: "icon"
				});
			}
		}, {
			key: 'blurInputPassword',
			value: function blurInputPassword() {
				this.setState({
					activ_password: "icon"
				});
			}
			...
			key: 'focusInputLogin',
			value: function focusInputLogin() {
				this.setState({
					activ_login: "icon activ"

				});
			}
		}, {
			key: 'focusInputPassword',
			value: function focusInputPassword() {
				this.setState({
					activ_password: "icon activ"
				});
			}
		}, {
			key: 'returnLogin',
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'autorize-item' },
						_react2.default.createElement(
							'div',
							{ className: this.state.activ_login },
						...
						_react2.default.createElement('input', {
							...
							onBlur: this.blurInputLogin,
							onFocus: this.focusInputLogin
						})
					),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: this.state.activ_password },
							_react2.default.createElement('i', { className: 'fa fa-lock fa-2x' })
						),
						_react2.default.createElement('input', (_React$createElement = {
							...
							type: 'password',
							placeholder: 'Enter password'
						}, _defineProperty(_React$createElement, 'type', 'text'), _defineProperty(_React$createElement, 'onChange', this.handler), _defineProperty(_React$createElement, 'onBlur', this.blurInputPassword), _defineProperty(_React$createElement, 'onFocus', this.focusInputPassword), _React$createElement))
					),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'div',
						{
							onClick: this.autorize,
							className: 'button'
						},
						'LOGIN'
					),
					...
					_react2.default.createElement(_modal2.default, { ref: 'opens' })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autorize = __webpack_require__(130);

	var _autorize2 = _interopRequireDefault(_autorize);
	...
	var _contentHome = __webpack_require__(133);
	...
	var Fedora = function (_React$Component) {
		_inherits(Fedora, _React$Component);

		function Fedora(props) {
			_classCallCheck(this, Fedora);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Fedora).call(this, props));
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_autorize2.default, null)
						)
					),
					_react2.default.createElement(
						'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fedora = __webpack_require__(131);
	...
	var HomeView = function (_React$Component) {
		...
		function HomeView(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HomeView).call(this, props));
		...
		_createClass(HomeView, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_fedora2.default, null),
					_react2.default.createElement(
						'button',
						null,
						' Hello '
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newsHome = __webpack_require__(134);

	var _newsHome2 = _interopRequireDefault(_newsHome);
	...
	var ContentHome = function (_React$Component) {
		...
		function ContentHome(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ContentHome).call(this, props));

			_this.displayName = 'ContentHome';
			return _this;
		}
		...
		_createClass(ContentHome, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'news' },
					_react2.default.createElement(_newsHome2.default, {
						styleMain: true,
						title: 'Create account',
						content: 'Not Sign up yet? Create account EJ now, it’s free.',
						icon: 'fa-codepen',
						size: 'fa-2x'
					}),
					_react2.default.createElement(_newsHome2.default, {
						title: 'News two',
						content: 'Simple text just for test',
					...
					_react2.default.createElement(_newsHome2.default, {
						...
						content: 'Here you can see the list of supported browsers',
						icon: 'fa-chrome',
						size: 'fa-2x',
					...
					_react2.default.createElement(_newsHome2.default, {
						...
						content: 'some very huge text copied several times in order to see how the whole thing will look like. some very huge text copied several times in order to see how the whole thing will look like. some very huge text copied several times in order to see how the whole thing will look like.',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tags = __webpack_require__(135);
	...
	var NewsHome = function (_React$Component) {
		_inherits(NewsHome, _React$Component);

		function NewsHome(props) {
			_classCallCheck(this, NewsHome);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NewsHome).call(this, props));

			_this.displayName = 'NewsHome';
			_this.icon = "icon " + _this.props.icon;
			_this.styleMain = _this.props.styleMain;
			return _this;
		}
		...
		_createClass(NewsHome, [{
			key: 'render',
			value: function render() {
				var htmlreadmore = _react2.default.createElement(
					'a',
					{ href: '#', onClick: this.readmore },
					'read more'
				);
				if (this.styleMain == true) {
					this.style = "main-news";
				} else {
					this.style = "news-item";
				}
				return _react2.default.createElement(
					'div',
					{ className: this.style },
					_react2.default.createElement(_icon2.default, { icon: this.icon, size: this.props.size }),
					_react2.default.createElement(
						'div',
						{ className: 'title' },
						this.props.title
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _teachers = __webpack_require__(74);
	...
	var TeacherMath = function (_React$Component) {
		_inherits(TeacherMath, _React$Component);

		function TeacherMath(props) {
			_classCallCheck(this, TeacherMath);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TeacherMath).call(this, props));

			_this.displayName = 'TeacherMath';
			return _this;
		}

		_createClass(TeacherMath, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'teacher-purple' },
					_react2.default.createElement(
						'div',
						{ className: 'head' },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_teachers2.default, {
							imgLink: '//lyceum9.com/images/MO/math/orehkova-mo.jpg',
							name: 'Орешкова Елена Валериевна',
							education: 'высшее, учитель высшей категории',
							description: 'Руководитель методического объединения',
							reward: 'Награждена грамотой Министерства образования и науки РФ'
						}),
						_react2.default.createElement(_teachers2.default, {
							imgLink: 'http://www.lyceum9.com/images/MO/math/ermakova-mo.jpg',
							name: 'Вероника Геннадиевна Ермакова',
							education: 'высшее',
							description: 'Учитель высшей категории, Выпускающий редактор газеты «Большая перемена»',
							reward: ''
						}),
						_react2.default.createElement(_teachers2.default, {
							imgLink: 'http://www.lyceum9.com/images/MO/math/golubeva-mo.jpg',
							name: 'Наталья георгиевна Голубева',
							education: 'высшее, Учитель высшей категории',
							description: '',
							reward: 'Отличник народного просвещения РСФСР'
						})
					),
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(_teachers2.default, {
							imgLink: 'http://www.lyceum9.com/images/MO/math/talejkkina-mo.jpg',
							name: 'Галина Александровна Талейкина',
							education: 'высшее, Учитель высшей категории',
							description: '',
							reward: 'Заслуженный учитель РФ'
						}),
						_react2.default.createElement(_teachers2.default, {
							imgLink: 'http://www.lyceum9.com/images/MO/math/kiseleva-mo.jpg',
							name: 'Наталья Николаевна Киселева',
							education: 'высшее, учитель математики высшей категории',
							description: '',
							reward: ''
						}),
						_react2.default.createElement(_teachers2.default, {
							imgLink: 'http://www.lyceum9.com/images/MO/math/pavluychenko-mo.jpg',
							name: 'Олег Игорьевич Павлюченко',
							education: 'высшее',
							description: 'Технический редактор газеты «Большая перемена»',
							reward: ''
						})
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeachersRus = function (_React$Component) {
		_inherits(TeachersRus, _React$Component);

		function TeachersRus(props) {
			_classCallCheck(this, TeachersRus);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TeachersRus).call(this, props));

			_this.displayName = 'TeachersRus';
			return _this;
		}

		_createClass(TeachersRus, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'grid-flex-container' },
					_react2.default.createElement(
						'div',
						{ className: 'teacher-success' },
						_react2.default.createElement(
							'div',
							{ className: 'head' },
						...
						_react2.default.createElement(
							...
							{ className: 'row' },
							_react2.default.createElement(_teachers2.default, {
								imgLink: '//lyceum9.com/images/MO/rus/kulachkova-mo.jpg',
								name: 'Кулачкова Ирина Михайловна',
								education: 'высшее, Руководитель методического объединения Учитель высшей категории',
								description: '',
								reward: 'Литературный редактор газеты «Большая перемена» Победитель в Приоритетном национальном проекте «Образование»'
							}),
							_react2.default.createElement(_teachers2.default, {
								imgLink: '//lyceum9.com/images/MO/rus/ivkina-mo.jpg',
								name: 'Ивкина Светлана Михайловна',
								education: 'высшее, ',
								description: 'Учитель высшей категории',
								reward: 'Заслуженный учитель РФ'
							}),
							_react2.default.createElement(_teachers2.default, {
								imgLink: '//lyceum9.com/images/MO/rus/ignatova-mo.jpg',
								name: 'Игнатова Галина Ивановна',
								education: 'высшее, Учитель высшей категории',
								description: '',
								reward: ''
							})
						...
						_react2.default.createElement(
							...
							{ className: 'row' },
							_react2.default.createElement(_teachers2.default, {
								imgLink: '//lyceum9.com/images/MO/rus/arxangelskaj-mo.jpg',
								name: 'Архангельская Лариса Алексеевна',
								education: 'высшее, Учитель высшей категории',
								description: '',
								reward: ''
							}),
							_react2.default.createElement(_teachers2.default, {
								imgLink: '//lyceum9.com/images/MO/rus/maliheva-mo.jpg',
								name: 'Малышева Татьяна Вячеславовна',
								education: 'высшее, учитель высшей категории',
								description: '',
								reward: ''
							}),
							_react2.default.createElement(_teachers2.default, {
								imgLink: '//lyceum9.com/images/MO/rus/merkuhenkova-mo.jpg',
								name: 'Меркушенкова Людмила Александровна',
								education: 'высшее, Учитель высшей категории',
								description: '',
								reward: ''
							})
						...
						_react2.default.createElement(
							...
							{ className: 'row' },
							_react2.default.createElement(_teachers2.default, {
								imgLink: '//lyceum9.com/images/MO/rus/carkova-mo.jpg',
								name: 'Царькова Ирина Владимировна',
								education: 'высшее, учитель высшей категории',
								description: '',
								reward: ''
							}),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _teacherMath = __webpack_require__(136);

	var _teacherMath2 = _interopRequireDefault(_teacherMath);

	var _teacherRus = __webpack_require__(137);

	var _teacherRus2 = _interopRequireDefault(_teacherRus);
	...
	var TeachersView = function (_React$Component) {
		_inherits(TeachersView, _React$Component);

		function TeachersView(props) {
			_classCallCheck(this, TeachersView);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TeachersView).call(this, props));

			_this.displayName = 'TeachersView';
			return _this;
		}

		_createClass(TeachersView, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'col-md-10' },
							_react2.default.createElement(_teacherMath2.default, null),
							_react2.default.createElement(_teacherRus2.default, null)
						)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 	renderReact() {
	// 		ReactDOM.render(<Router history={hashHistory} routes={RouteConfig} />, this.container);
	// 	}
	// }
	...
	var ApplicationService = function () {
		function ApplicationService(container) {
		...
		_createClass(ApplicationService, [{
			...
			value: function renderReact() {
				_reactDom2.default.render(_react2.default.createElement(_docsView2.default, null), this.container);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateBrowserHistory = __webpack_require__(144);
